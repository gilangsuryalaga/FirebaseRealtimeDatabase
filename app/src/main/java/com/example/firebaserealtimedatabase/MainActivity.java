...
public class MainActivity extends AppCompatActivity {
    public static final String ARTIST_NAME = "arrtistname";
    public static final String ARTIST_ID = "arrtistid";
    ...
    private boolean updateArtist(String id, String name, String genre){
        ...
        Toast.makeText(this, "Artist Updated Succesfully", Toast.LENGTH_LONG).show();
